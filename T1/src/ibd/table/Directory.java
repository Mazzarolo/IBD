...
import ibd.table.management.HeapTableJoaoMazzarolo;
...
public class Directory {
    ...
    public static Table getTable(String folder, String name, int pageSize, boolean override) throws Exception {
        ...
        //t = new OrderedTable(folder, name, pageSize, override);
        ...
        t = new HeapTableJoaoMazzarolo(folder, name, pageSize, override);
        t.key = key;
        tables2.put(key, t);
        return t;
